...
# Catalog_ПоступлениеДопРасходовПрисоединенныеФайлы
...
| УдалитьЭлектронныеПодписи | Catalog_ПоступлениеДопРасходовПрисоединенныеФайлы_УдалитьЭлектронныеПодписи_RowType | true |
| УдалитьСертификатыШифрования | Catalog_ПоступлениеДопРасходовПрисоединенныеФайлы_УдалитьСертификатыШифрования_RowType | true |
...
- [[Document_ПоступлениеДопРасходов]] — ВладелецФайла
