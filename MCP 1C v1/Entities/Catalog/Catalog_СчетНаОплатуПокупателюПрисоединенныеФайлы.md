...
| УдалитьЭлектронныеПодписи | Catalog_СчетНаОплатуПокупателюПрисоединенныеФайлы_УдалитьЭлектронныеПодписи_RowType | true |
| УдалитьСертификатыШифрования | Catalog_СчетНаОплатуПокупателюПрисоединенныеФайлы_УдалитьСертификатыШифрования_RowType | true |
...
- [[Document_СчетНаОплатуПокупателю]] — ВладелецФайла
