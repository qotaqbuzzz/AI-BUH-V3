...
# Catalog_КомандировкиОрганизацийПрисоединенныеФайлы
...
| УдалитьЭлектронныеПодписи | Catalog_КомандировкиОрганизацийПрисоединенныеФайлы_УдалитьЭлектронныеПодписи_RowType | true |
| УдалитьСертификатыШифрования | Catalog_КомандировкиОрганизацийПрисоединенныеФайлы_УдалитьСертификатыШифрования_RowType | true |
...
- [[Document_КомандировкиОрганизаций]] — ВладелецФайла
