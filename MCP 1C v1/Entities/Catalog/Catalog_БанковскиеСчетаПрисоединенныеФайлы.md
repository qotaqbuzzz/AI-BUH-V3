...
# Catalog_БанковскиеСчетаПрисоединенныеФайлы
...
| УдалитьЭлектронныеПодписи | Catalog_БанковскиеСчетаПрисоединенныеФайлы_УдалитьЭлектронныеПодписи_RowType | true |
| УдалитьСертификатыШифрования | Catalog_БанковскиеСчетаПрисоединенныеФайлы_УдалитьСертификатыШифрования_RowType | true |
...
- [[Catalog_БанковскиеСчета]] — ВладелецФайла
