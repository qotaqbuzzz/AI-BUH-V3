...
# Catalog_ИсполнительныйЛистПрисоединенныеФайлы
...
| УдалитьЭлектронныеПодписи | Catalog_ИсполнительныйЛистПрисоединенныеФайлы_УдалитьЭлектронныеПодписи_RowType | true |
| УдалитьСертификатыШифрования | Catalog_ИсполнительныйЛистПрисоединенныеФайлы_УдалитьСертификатыШифрования_RowType | true |
...
- [[Document_ИсполнительныйЛист]] — ВладелецФайла
