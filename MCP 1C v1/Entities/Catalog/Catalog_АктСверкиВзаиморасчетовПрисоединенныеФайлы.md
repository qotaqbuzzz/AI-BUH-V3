...
# Catalog_АктСверкиВзаиморасчетовПрисоединенныеФайлы
...
| УдалитьЭлектронныеПодписи | Catalog_АктСверкиВзаиморасчетовПрисоединенныеФайлы_УдалитьЭлектронныеПодписи_RowType | true |
| УдалитьСертификатыШифрования | Catalog_АктСверкиВзаиморасчетовПрисоединенныеФайлы_УдалитьСертификатыШифрования_RowType | true |
...
- [[Document_АктСверкиВзаиморасчетов]] — ВладелецФайла
