...
| УдалитьЭлектронныеПодписи | Catalog_ОрганизацииПрисоединенныеФайлы_УдалитьЭлектронныеПодписи_RowType | true |
| УдалитьСертификатыШифрования | Catalog_ОрганизацииПрисоединенныеФайлы_УдалитьСертификатыШифрования_RowType | true |
...
- [[Catalog_Организации]] — ВладелецФайла
