...
| УдалитьЭлектронныеПодписи | Catalog_ФизическиеЛицаПрисоединенныеФайлы_УдалитьЭлектронныеПодписи_RowType | true |
| УдалитьСертификатыШифрования | Catalog_ФизическиеЛицаПрисоединенныеФайлы_УдалитьСертификатыШифрования_RowType | true |
...
- [[Catalog_ФизическиеЛица]] — ВладелецФайла
