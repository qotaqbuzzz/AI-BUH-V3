...
# Catalog_СчетНаОплатуПоставщикаПрисоединенныеФайлы
...
| УдалитьЭлектронныеПодписи | Catalog_СчетНаОплатуПоставщикаПрисоединенныеФайлы_УдалитьЭлектронныеПодписи_RowType | true |
| УдалитьСертификатыШифрования | Catalog_СчетНаОплатуПоставщикаПрисоединенныеФайлы_УдалитьСертификатыШифрования_RowType | true |
...
- [[Document_СчетНаОплатуПоставщика]] — ВладелецФайла
