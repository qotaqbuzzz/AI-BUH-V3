...
export declare const toGuid: (s: string) => Guid;
...
export declare const DOCUMENT_TYPES: readonly ["РеализацияТоваровУслуг", "ПоступлениеТоваровУслуг", "ПлатежноеПоручениеИсходящее", "ПлатежноеПоручениеВходящее", "ПриходныйКассовыйОрдер", "РасходныйКассовыйОрдер", "ПеремещениеТоваров", "ТребованиеНакладная", "НачислениеЗарплатыРаботникамОрганизаций", "ЗакрытиеМесяца", "АвансовыйОтчет", "ЭСФ", "СчетФактураВыданный"];
...
export type Contractor = Pick<Catalog_Контрагенты, "Ref_Key" | "Description" | "НаименованиеПолное" | "РНН" | "ИдентификационныйКодЛичности" | "КБЕ" | "ЮрФизЛицо" | "НомерСвидетельстваПоНДС" | "ОсновнойДоговорКонтрагента_Key" | "ОсновнойБанковскийСчет_Key" | "Parent_Key" | "IsFolder" | "DeletionMark">;
/** @deprecated Use Catalog_Номенклатура */
export type Nomenclature = Pick<Catalog_Номенклатура, "Ref_Key" | "Description" | "НаименованиеПолное" | "Артикул" | "Услуга" | "БазоваяЕдиницаИзмерения_Key" | "СтавкаНДС_Key" | "НоменклатурнаяГруппа_Key" | "ИдентификаторТовараЭСФ" | "КодТНВЭД" | "Parent_Key" | "IsFolder" | "DeletionMark">;
/** @deprecated Use Catalog_Организации */
export type Organization = Pick<Catalog_Организации, "Ref_Key" | "Description" | "НаименованиеПолное" | "ИдентификационныйНомер" | "РНН" | "НомерСвидетельстваПоНДС" | "ОсновнойБанковскийСчет_Key" | "DeletionMark">;
