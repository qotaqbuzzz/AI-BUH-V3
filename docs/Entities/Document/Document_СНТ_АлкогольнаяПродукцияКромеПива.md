...
# Document_СНТ_АлкогольнаяПродукцияКромеПива
...
| ВидПродукта | Edm.String | true |
| ПинКод | Edm.String | true |
| ЕмкостьТары | Edm.Double | true |
| КоличествоБутылок | Edm.Int64 | true |
| УдалитьОблагаемыйИмпорт | Edm.Double | true |
| ОборотПоРеализации | Edm.Double | true |
| Крепость | Edm.Double | true |
| УдалитьСтавкаДополнительногоАкциза | Edm.Double | true |
