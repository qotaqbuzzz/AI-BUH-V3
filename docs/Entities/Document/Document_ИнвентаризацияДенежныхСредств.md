...
# Document_ИнвентаризацияДенежныхСредств
...
| ДенежныеСредства | Document_ИнвентаризацияДенежныхСредств_ДенежныеСредства_RowType | true |
| ИнвентаризационнаяКомиссия | Document_ИнвентаризацияДенежныхСредств_ИнвентаризационнаяКомиссия_RowType | true |
