...
| ДокументЗакрытиеМесяца_Key | Edm.Guid | true |
...
| Состав | Document_ДвижениеНЗП_Состав_RowType | true |
...
- [[Document_ЗакрытиеМесяца]] — ДокументЗакрытиеМесяца
