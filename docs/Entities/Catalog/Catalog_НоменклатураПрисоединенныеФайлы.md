...
| УдалитьЭлектронныеПодписи | Catalog_НоменклатураПрисоединенныеФайлы_УдалитьЭлектронныеПодписи_RowType | true |
| УдалитьСертификатыШифрования | Catalog_НоменклатураПрисоединенныеФайлы_УдалитьСертификатыШифрования_RowType | true |
...
- [[Catalog_Номенклатура]] — ВладелецФайла
