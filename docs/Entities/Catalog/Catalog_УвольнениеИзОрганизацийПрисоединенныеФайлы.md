...
# Catalog_УвольнениеИзОрганизацийПрисоединенныеФайлы
...
| УдалитьЭлектронныеПодписи | Catalog_УвольнениеИзОрганизацийПрисоединенныеФайлы_УдалитьЭлектронныеПодписи_RowType | true |
| УдалитьСертификатыШифрования | Catalog_УвольнениеИзОрганизацийПрисоединенныеФайлы_УдалитьСертификатыШифрования_RowType | true |
...
- [[Document_УвольнениеИзОрганизаций]] — ВладелецФайла
