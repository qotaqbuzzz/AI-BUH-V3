...
# Catalog_КадровоеПеремещениеОрганизацийПрисоединенныеФайлы
...
| УдалитьЭлектронныеПодписи | Catalog_КадровоеПеремещениеОрганизацийПрисоединенныеФайлы_УдалитьЭлектронныеПодписи_RowType | true |
| УдалитьСертификатыШифрования | Catalog_КадровоеПеремещениеОрганизацийПрисоединенныеФайлы_УдалитьСертификатыШифрования_RowType | true |
...
- [[Document_КадровоеПеремещениеОрганизаций]] — ВладелецФайла
