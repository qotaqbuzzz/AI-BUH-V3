...
# Catalog_ОсновныеСредстваПрисоединенныеФайлы
...
| УдалитьЭлектронныеПодписи | Catalog_ОсновныеСредстваПрисоединенныеФайлы_УдалитьЭлектронныеПодписи_RowType | true |
| УдалитьСертификатыШифрования | Catalog_ОсновныеСредстваПрисоединенныеФайлы_УдалитьСертификатыШифрования_RowType | true |
...
- [[Catalog_ОсновныеСредства]] — ВладелецФайла
