...
# Catalog_ПлатежноеПоручениеИсходящееПрисоединенныеФайлы
...
| УдалитьЭлектронныеПодписи | Catalog_ПлатежноеПоручениеИсходящееПрисоединенныеФайлы_УдалитьЭлектронныеПодписи_RowType | true |
| УдалитьСертификатыШифрования | Catalog_ПлатежноеПоручениеИсходящееПрисоединенныеФайлы_УдалитьСертификатыШифрования_RowType | true |
...
- [[Document_ПлатежноеПоручениеИсходящее]] — ВладелецФайла
