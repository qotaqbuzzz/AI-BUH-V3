...
# Catalog_НематериальныеАктивыПрисоединенныеФайлы
...
| УдалитьЭлектронныеПодписи | Catalog_НематериальныеАктивыПрисоединенныеФайлы_УдалитьЭлектронныеПодписи_RowType | true |
| УдалитьСертификатыШифрования | Catalog_НематериальныеАктивыПрисоединенныеФайлы_УдалитьСертификатыШифрования_RowType | true |
...
- [[Catalog_НематериальныеАктивы]] — ВладелецФайла
