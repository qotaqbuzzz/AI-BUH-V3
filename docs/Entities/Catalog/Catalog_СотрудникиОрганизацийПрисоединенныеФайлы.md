...
# Catalog_СотрудникиОрганизацийПрисоединенныеФайлы
...
| УдалитьЭлектронныеПодписи | Catalog_СотрудникиОрганизацийПрисоединенныеФайлы_УдалитьЭлектронныеПодписи_RowType | true |
| УдалитьСертификатыШифрования | Catalog_СотрудникиОрганизацийПрисоединенныеФайлы_УдалитьСертификатыШифрования_RowType | true |
...
- [[Catalog_СотрудникиОрганизаций]] — ВладелецФайла
