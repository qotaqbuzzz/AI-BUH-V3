...
# Catalog_ТиповыеОперации_Налоговый
...
| ВидУчетаДт_Key | Edm.Guid | true |
| Формулы | Edm.String | true |
| Условие | Edm.String | true |
| ВидУчетаКт_Key | Edm.Guid | true |
...
- [[Catalog_ВидыУчетаНУ]] — ВидУчетаДт
- [[Catalog_ВидыУчетаНУ]] — ВидУчетаКт
- [[ChartOfAccounts_Налоговый]] — СчетДт
- [[ChartOfAccounts_Налоговый]] — СчетКт
